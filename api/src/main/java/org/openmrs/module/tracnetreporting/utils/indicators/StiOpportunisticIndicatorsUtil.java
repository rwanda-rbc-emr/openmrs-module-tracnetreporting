 ...
 *
 */
public class StiOpportunisticIndicatorsUtil {
	...
	public static int clientsCounceledForStiThisMonth(SessionFactory sessionFactory, String startDate, String endDate) {
	...
	public static int opportInfectTreatedExcludeTbThisMonth(SessionFactory sessionFactory, String startDate, String endDate) {
		// TODO Auto-generated method stub
		return 0;
	}
	...
	public static int stiDiagnosedThisMonth(SessionFactory sessionFactory, String startDate, String endDate) {
		// TODO Auto-generated method stub
		return 0;
	}
